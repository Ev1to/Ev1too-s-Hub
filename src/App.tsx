...
const Navbar = () => {
  ...
  const socialLinks = [
    ...
    { 
      href: 'https://discord.gg/ChsWSf3E', 
        ...
        <div className="space-y-4">
          <div className="relative group">
            <input
              type="text"
              placeholder="Name"
              className="w-full p-3 bg-background/50 rounded-lg border border-primary/20 focus:border-primary/60 outline-none transition-all duration-300 backdrop-blur-sm"
            />
            <div className="absolute -inset-0.5 bg-primary/20 rounded-lg blur opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-all duration-300 -z-10"></div>
          </div>
          <div className="relative group">
            <input
              type="email"
          ...
          <div className="relative group">
            <textarea
              placeholder="Message"
              rows={5}
              className="w-full p-3 bg-background/50 rounded-lg border border-primary/20 focus:border-primary/60 outline-none transition-all duration-300 backdrop-blur-sm resize-none"
            />
            <div className="absolute -inset-0.5 bg-primary/20 rounded-lg blur opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-all duration-300 -z-10"></div>
          </div>
          <div className="relative group">
            <button className="w-full py-4 bg-primary/20 backdrop-blur-sm border border-primary/50 text-primary rounded-lg group-hover:bg-primary/30 transition-all duration-300 relative">
              <span className="relative z-10 font-medium tracking-wider glow-text">SEND MESSAGE</span>
              <div className="absolute inset-0 bg-primary/20 rounded-lg blur-lg opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
            </button>
            <div className="absolute -inset-0.5 bg-gradient-to-r from-primary/50 to-secondary/50 rounded-lg blur opacity-0 group-hover:opacity-100 transition-all duration-300 -z-10 animate-pulse"></div>
          </div>
        </div>
      </div>
    </div>
